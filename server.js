...
let imagesData = fs.existsSync(imagesFile)
  ? JSON.parse(fs.readFileSync(imagesFile))
  : [];
let votesData = fs.existsSync(votesFile)
...
function saveVotes() {
  fs.writeFileSync(votesFile, JSON.stringify(votesData));
}
...
app.get("/gallery", (req, res) =>
  res.json(imagesData.sort((a, b) => b.votes - a.votes))
);
